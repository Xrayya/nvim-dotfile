-- see https://git.sr.ht/~whynothugo/lsp_lines.nvim for advance info
-- I copy this folder manually because I don't know how to clone this repo from the url

local M = {}

local render = require("lsp-lines.render")
