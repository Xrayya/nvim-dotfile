...
set.hidden = true -- Required to keep multiple buffers open multiple buffersoptio
...
set.guifont = "JetBrainsMono\\ NF:h11" -- the font used in graphical neovim applications
